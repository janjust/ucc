...
#define UCC_TL_SHM_N_PERF_PARAMS           24
#define UCC_TL_SHM_N_PERF_PARAMS_GENERIC   2
...
extern ucc_tl_shm_perf_key_t *ucc_tl_shm_perf_params_generic[UCC_TL_SHM_N_PERF_PARAMS_GENERIC];
